...
- **`packages/codex-cli/`** - Provisional Codex CLI skills projection. Its skills are **auto-generated** from core; the manifest and package docs are hand-authored.
