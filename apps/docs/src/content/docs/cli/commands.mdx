...
published npm package under `~/.cache/maestria/` before invoking those managers. Claude Code
configuration remains host-owned; Codex also receives Maestria-managed native agent TOMLs under
`$CODEX_HOME/agents/`.
