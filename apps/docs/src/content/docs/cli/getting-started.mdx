...
description: Install and use maestria to manage maestria plugins across OpenCode, Kimi Code, Pi, Hermes, Claude Code, and Codex CLI.
---
...
<AllPackageManagers type="dlx" pkg="maestria@latest" args="install codex-cli" />
