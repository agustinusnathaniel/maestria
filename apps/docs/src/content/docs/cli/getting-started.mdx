...
Run <AllPackageManagers type="dlx" pkg="maestria" /> with no arguments - it defaults to `status`.

### Install for a platform

**Interactive install** (pick from a list of detected platforms):

<AllPackageManagers type="dlx" pkg="maestria" args="install" />
...
<AllPackageManagers type="dlx" pkg="maestria" args="install opencode" />
<AllPackageManagers type="dlx" pkg="maestria@latest" args="install pi" />
<AllPackageManagers type="dlx" pkg="maestria" args="install kimi-code" />

### Update to the latest version

**Interactive update:**

<AllPackageManagers type="dlx" pkg="maestria" args="update" />
...
<AllPackageManagers type="dlx" pkg="maestria" args="configure opencode --set reviewer=" />
...
<AllPackageManagers type="dlx" pkg="maestria" args="status --json" />
...
<AllPackageManagers type="dlx" pkg="maestria" args="install --all --json" />
...
<AllPackageManagers type="dlx" pkg="maestria" args="status --compact" />
...
<AllPackageManagers type="dlx" pkg="maestria" args="install --all --quiet" />

<Aside type="tip">
  Combine `--quiet` with `--json` for clean CI output:{' '}
  <AllPackageManagers type="dlx" pkg="maestria" args="status --json --quiet" />
</Aside>
