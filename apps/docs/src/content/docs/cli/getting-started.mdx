...
Run <PackageManagers type="dlx" pkg="maestria" /> with no arguments - it defaults to `status`.

### Install for a platform

**Interactive install** (pick from a list of detected platforms):

<PackageManagers type="dlx" pkg="maestria" args="install" />
...
<PackageManagers type="dlx" pkg="maestria" args="install opencode" />
...
<PackageManagers type="dlx" pkg="maestria" args="update" />
...
<PackageManagers type="dlx" pkg="maestria" args="update opencode --version 0.5.0" />
...
<PackageManagers type="dlx" pkg="maestria" args="configure opencode --set reviewer=" />
...
<PackageManagers type="dlx" pkg="maestria" args="status --json" />
...
<PackageManagers type="dlx" pkg="maestria" args="install --all --json" />
...
<PackageManagers type="dlx" pkg="maestria" args="status --compact" />
...
<PackageManagers type="dlx" pkg="maestria" args="install --all --quiet" />

<Aside type="tip">
  Combine `--quiet` with `--json` for clean CI output:{' '}
  <PackageManagers type="dlx" pkg="maestria" args="status --json --quiet" />
</Aside>
