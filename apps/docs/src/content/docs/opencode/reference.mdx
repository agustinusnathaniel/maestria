...
- Agent-level tool permissions from frontmatter are honored by native OpenCode sessions; t3code's full-access mode can bypass those restrictions (see Known limitations)
