...
1. **npm global install:** <AllPackageManagers type="global" pkg="@colbymchenry/codegraph" />
2. **Run without install:** <AllPackageManagers type="dlx" pkg="@colbymchenry/codegraph" />
