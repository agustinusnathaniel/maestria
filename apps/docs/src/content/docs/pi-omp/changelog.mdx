...
- Canonical agent directives are ~26% leaner: the bounded-repair contract lives once in the global rules, specialist skill catalogs list only verified skills, and dead sync-config replacement anchors were removed.
