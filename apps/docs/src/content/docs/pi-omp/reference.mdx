...
> Historically called Spec-Driven Delegation. The model is now [contract-driven delegation](https://github.com/agustinusnathaniel/maestria/blob/main/docs/adr/core/ADR-CORE-026-contract-driven-delegation.md): compact handoffs, spec-aware but format-agnostic, with persistent intent refs via the [spec-contract skill](https://github.com/agustinusnathaniel/maestria/blob/main/skills/spec-contract/SKILL.md) only when they reduce risk.
