...
<Aside type="caution" title="Prompt-level maker/checker">
  Cursor agents do not hard-deny write tools yet. Reviewer/adventurer/planner prompts forbid edits;
  do not ask the same agent that implemented to review its own work.
</Aside>
