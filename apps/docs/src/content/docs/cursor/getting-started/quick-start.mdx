...
<Aside type="caution" title="Full orchestration is not always the best path">
  Use [the usage decision guide](/core/when-to-use/) before starting `/fein`. Direct execution or
  one specialist is often better for small changes, interactive work, and expensive or slow models.
</Aside>
