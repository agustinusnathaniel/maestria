...
description: How to install @maestria/hermes on your Hermes Agent and what you get - 9 methodology skills plus 3 command skills, 6 slash commands, and role-neutral child trust boundaries.
---

import { Steps, Aside, Tabs, TabItem, Code } from '@astrojs/starlight/components';
import { PackageManagers } from 'starlight-package-managers';

`@maestria/hermes` is a git-based Hermes plugin that turns your Hermes Agent into a disciplined methodology worker. It registers 9 methodology skills plus 3 command skills, 6 slash commands, role-neutral child trust, and lifecycle hooks - all installed with a single `hermes plugins install` command.
