...
- **31 vitest assertions** — validate manifest schema, frontmatter, rules budget, and persona safety constraints (reviewer no-edit, adventurer read-only Bash)

See [ADR-004](https://github.com/maestria/maestria/blob/main/docs/adr/ADR-004-kimi-code-architecture.md) for the full design rationale.
