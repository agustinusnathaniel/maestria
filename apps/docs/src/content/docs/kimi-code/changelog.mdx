...
- **31 vitest tests** — validate manifest schema, frontmatter, rules budget, and persona safety constraints (reviewer no-edit, adventurer read-only Bash)

See [ADR-009](https://github.com/agustinusnathaniel/maestria/blob/main/docs/adr/kimi-code/ADR-009-kimi-code-architecture.md) for the full design rationale.
