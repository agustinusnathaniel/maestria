...
2. **Add the skill to the orchestrator's routing table**
   ...
   Edit `packages/kimi-code/skills/orchestrator/SKILL.md` to add the new specialist to the "7 Specialists" table and the "Specialist → Subagent Routing Table". Update `rules/AGENTS.md` similarly.
...
<Aside type="caution">
  The "7 specialists" label in the orchestrator and rules is load-bearing — the table count and the
