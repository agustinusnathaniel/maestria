...
1. **Install the plugin**
   ...
   By default, Kimi Code follows the **latest release** of the `maestria/maestria` repository. To pin a specific version:

   | Pin type   | URL form                                                   |
   | ---------- | ---------------------------------------------------------- |
   | **Latest** | `https://github.com/maestria/maestria`                     |
   | **Tag**    | `https://github.com/maestria/maestria/releases/tag/v0.1.0` |
   | **Branch** | `https://github.com/maestria/maestria/tree/main#branch`    |
   | **SHA**    | `https://github.com/maestria/maestria/tree/abc1234#sha`    |
...
2. **Place global rules (REQUIRED)**
   ...
   <Aside type="caution">
     ...
     truncates AGENTS.md content past 32 KB with a marker.
   </Aside>
...
Kimi Code follows the latest release by default. To update, run `/plugins install https://github.com/maestria/maestria` again. Pin to a tag or SHA for production work.
