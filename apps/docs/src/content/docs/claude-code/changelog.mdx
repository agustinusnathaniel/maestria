...
- Canonical agent directives are ~26% leaner: the bounded-repair contract lives once in the global rules and specialist skill catalogs list only verified skills.
