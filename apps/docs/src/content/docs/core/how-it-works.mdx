...
<Aside type="caution" title="The pipeline has a cost">
  Every delegated stage adds model work, context transfer, and waiting time. Use [When to Use
  Maestria](/core/when-to-use/) to decide whether that cost is justified.
</Aside>
