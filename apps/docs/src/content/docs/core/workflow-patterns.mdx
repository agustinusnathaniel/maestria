...
Mandatory review after every Builder change remains the default - multi-lens is an enhancement for when one reviewer can't give each dimension proper attention.
