...
| `@maestria/codex`       | `packages/codex-cli/sync.config.ts`   | Namespaced skills, workflow modes as skills, and advisory role boundaries                  |
