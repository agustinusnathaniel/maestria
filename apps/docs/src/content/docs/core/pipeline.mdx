...
| **Fast implementation** | `@builder` only - skip optional recon/design ceremony; keep required review | Quick fixes in known territory where the design is obvious and risk is low.                           |
