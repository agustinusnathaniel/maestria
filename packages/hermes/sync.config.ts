  ...
  files: {
    ...
    'builder.md': {
      ...
      append: [
        ...
        '## OpenCode Routing',
        '',
        "For complex multi-file coding tasks that benefit from OpenCode's dedicated",
        'sandbox, use the `opencode_route` tool. Simple tasks use Hermes built-in',
        'tools (edit, write, bash) directly.',
        '',
