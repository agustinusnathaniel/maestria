...
See [ADR-KC-001](../../docs/adr/kimi-code/ADR-KC-001-kimi-code-architecture.md) for the full
design rationale.
...
- [ADR-KC-001](../../docs/adr/kimi-code/ADR-KC-001-kimi-code-architecture.md) — the architecture
