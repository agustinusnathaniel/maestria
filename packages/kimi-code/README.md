...
See [ADR-011](../../docs/adr/kimi-code/ADR-011-kimi-code-architecture.md) for the full
design rationale.
...
- [ADR-011](../../docs/adr/kimi-code/ADR-011-kimi-code-architecture.md) — the architecture
