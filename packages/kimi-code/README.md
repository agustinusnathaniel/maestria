...
See [ADR-009](../../docs/adr/kimi-code/ADR-009-kimi-code-architecture.md) for the full
design rationale.
...
- [ADR-009](../../docs/adr/kimi-code/ADR-009-kimi-code-architecture.md) — the architecture
