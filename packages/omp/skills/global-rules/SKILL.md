...
When delegating work in a focused or full route, use only the 7 specialists below. **Never delegate to platform-native built-in agents** - they are built-in, not part of the pipeline. Direct routes do not delegate.
