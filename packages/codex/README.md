...
- Support remains provisional until the pinned Codex CLI behavior and the marketplace/plugin install flow are reverified. Evidence baseline: [runtime support matrix](../../docs/runtime-support-matrix.md) and [ADR-CORE-014](../../docs/adr/core/ADR-CORE-014-runtime-support-and-adapter-policy.md).
