...
// values that differ: the @-mention rewrite prefix and the product name in the
...
// oxlint-disable-next-line max-lines-per-function -- one declarative mapping: the shared 14-file directive table inlined as data. Splitting it would fragment a single reviewable mapping and hide the two platform differences as parameters.
