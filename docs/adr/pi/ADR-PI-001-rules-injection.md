...
Generated by `sync-skills.config.ts` from canonical sources, output to `skills/orchestrator/SKILL.md` and `skills/global-rules/SKILL.md`. Auto-injected by Pi's resource loader via `pi.skills` manifest field.
